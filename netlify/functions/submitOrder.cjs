exports.handler = async (event) => {
  ...
  try {
    ...
    // Safely extracting all order data
    const {
      name,
      mobile,
      orderType,
    ...
    // Handle both instruction and instructions safely
    const cookingNotes =
    ...
    const record = {
      fields: {
        ...
        // Email will be empty when customer didn't select email option
