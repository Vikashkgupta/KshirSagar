              ...
              {hasVariant ? (
                variants.map((v, i) => (
                  <div key={i} className="flex items-center justify-between gap-[0.8rem] pb-[0.85rem] border-b border-dashed border-gold/30 last:pb-0 last:border-none">
                    ...
                    <button onClick={() => handleAdd(v.price, v.label)} className="h-[50px] min-w-[120px] px-[1.7rem] bg-gradient-to-r from-[#8B6B1E] via-[#D4AF37] to-[#8B6B1E] hover:from-[#A67C1F] hover:via-[#E2C15A] hover:to-[#A67C1F] border border-[#E7C86A] rounded-full text-white font-inter text-[0.82rem] font-extrabold tracking-[0.08em] cursor-pointer shadow-[0_8px_22px_rgba(212,175,55,0.32)] transition-all duration-300 flex items-center justify-center gap-[0.45rem] hover:-translate-y-[2px] hover:shadow-[0_12px_28px_rgba(212,175,55,0.42)] active:scale-[0.96]">
                      ADD
                    </button>
                  </div>
                ))
                ...
                <div className="flex items-center justify-between gap-[0.8rem]">
                  ...
                  <button onClick={() => handleAdd(item.price, '')} className="h-[50px] px-[1.9rem] bg-gradient-to-r from-[#8B6B1E] via-[#D4AF37] to-[#8B6B1E] hover:from-[#A67C1F] hover:via-[#E2C15A] hover:to-[#A67C1F] border border-[#E7C86A] rounded-full text-white font-inter text-[0.85rem] font-extrabold tracking-[0.08em] cursor-pointer shadow-[0_8px_22px_rgba(212,175,55,0.32)] transition-all duration-300 uppercase flex items-center justify-center gap-[10px] hover:-translate-y-[2px] hover:shadow-[0_12px_30px_rgba(212,175,55,0.45)] active:scale-[0.96]">
